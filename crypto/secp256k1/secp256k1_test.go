...
func TestEthereumMessage(t *testing.T) {
	tests := []struct {
		...
		{
			msg: []byte("my message"),
			sig: hexutils.HexToBytes("6C5F939148250C526CCA7436DFA6B394C8195AD271FD88AA269D161C7642C3B74FEEB9E19F1821E89631F1375B1B00FCF9D6AD9CE29DFC4AF1B9E463C44AE9D01B"),
		},
		{
			msg: []byte("hello world"),
			sig: hexutils.HexToBytes("711A48DD85885160D68510E259C6DE72C1722D7B5AD6ADB2808E032299FB8DBE054444B125763AC0AF08952D9E091C35F44C90EC3524AFB45CE1AFFEC2D56FA31B"),
		},
	}
